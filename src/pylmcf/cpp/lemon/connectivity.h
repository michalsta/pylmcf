...
namespace lemon {
  ...
  bool stronglyConnected(const Digraph& digraph) {
    ...
    [[maybe_unused]] typedef typename Digraph::Node Node;
  ...
  int countStronglyConnectedComponents(const Digraph& digraph) {
    ...
    [[maybe_unused]] typedef typename Digraph::Node Node;
    [[maybe_unused]] typedef typename Digraph::Arc Arc;
    typedef typename Digraph::NodeIt NodeIt;
    [[maybe_unused]] typedef typename Digraph::ArcIt ArcIt;
  ...
  bool bipartite(const Graph &graph){
    ...
    typedef typename Graph::NodeIt NodeIt;
    [[maybe_unused]] typedef typename Graph::ArcIt ArcIt;
  ...
  bool bipartitePartitions(const Graph &graph, NodeMap &partMap){
    ...
    [[maybe_unused]] typedef typename Graph::Node Node;
    typedef typename Graph::NodeIt NodeIt;
    [[maybe_unused]] typedef typename Graph::ArcIt ArcIt;
